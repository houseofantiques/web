...
const I18N = {
  ar: {
    ...
    c1t:"تجربة متحفية فاخرة", c1p:"بيت التحفيات مساحة ثقافية تنبض بذاكرة بغداد، تلتقي فيها التحف النادرة مع حكايات الزمن، بيتٌ يحتضن الفن والذوق والتاريخ في مكان واحد، ويفتح أبوابه لكل من يبحث عن الجمال والمعنى، بعيدًا عن العابر… وقريبًا من الذاكرة.",
